...
class Ui_NurOSHello(object):
    def setupUi(self, NurOSHello):
        ...
        NurOSHello.setWindowModality(Qt.WindowModal)
        NurOSHello.resize(800, 600)
        icon = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.Battery))
        NurOSHello.setWindowIcon(icon)
        NurOSHello.setLocale(QLocale(QLocale.English, QLocale.UnitedStates))
        ...
        self.label_3.setGeometry(QRect(20, 170, 761, 281))
        font2 = QFont()
        ...
        self.label_6.setGeometry(QRect(490, 510, 81, 18))
    ...
    def retranslateUi(self, NurOSHello):
        NurOSHello.setWindowTitle(QCoreApplication.translate("NurOSHello", u"Welcome To NurOS", None))
        ...
        self.label_3.setText(QCoreApplication.translate("NurOSHello", u"<html><head/><body><p>The new and indepent operating system based on Linux! You can work with your favourite programs such as</p><p>FreeOffice OBS Studio, Blender and Google Chrome with comfort quality and performance.</p><p>We are developers from non-big company and we can know about user's issues and you can install or delete from</p><p>system any packages. Our Linux distribution is minimal and clean out-of-box, but you can still install any other</p><p>packages such as proprietary. You can support us via Patreon or go to work with us! Check our Telegram below for</p><p>news, updates and questions. If you have any questions or ideas, you can ask on our Telegram channel.</p><p><br/></p><p><br/>By pressing the button below, you will be a member of NurOS   ;&gt;</p></body></html>", None))
